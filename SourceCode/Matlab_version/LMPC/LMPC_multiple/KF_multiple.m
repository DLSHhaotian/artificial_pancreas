function [x_bar,z_bar,P_kf] = KF_multiple(T,uk,x_bar,P_kf,R_kf,W_kf,G_w,dk,yk,Ad,Bd,Bd_d,Css,us_MVP,xs_MVP,ys)
% Syntax: [x_bar,z_bar,P_kf] = KF_multiple(T,uk,x_bar,P_kf,R_kf,W_kf,G_w,dk,yk,Ad,Bd,Bd_d,Css,us_MVP,xs_MVP,ys)
%         T: sampling time
