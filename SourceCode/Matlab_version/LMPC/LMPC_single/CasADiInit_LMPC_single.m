function solver = CasADiInit_LMPC_single(N,T,Ad,Bd,Bd_d,Css,xs_MVP,us_MVP,z_min,z_max,z_ref,u_min,u_max,Wz,Weta_min,Weta_max,Wu_ba,Wu_delta_ba,Wu_bo)
...
g=Mx0*x_bar+Mr*(z_ref*ones(N,1))+Mu_delta*u_1+Md*dmeal;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Az_cons_min=Gam;
