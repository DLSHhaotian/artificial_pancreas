function u_opt = CasADiCompute_LMPC_multiple(N,T,Ad,Bd,Bd_d,Css,xs_MVP,us_MVP,z_min,z_max,z_ref,u_min,u_max,Wz,Weta_min,Weta_max,Wu_ba,Wu_delta_ba,Wu_bo,Wu_glu,x_bar,dmeal,u_1,OPT_var_x0,solver)
% Syntax: u_opt = CasADiCompute_LMPC_multiple(N,T,Ad,Bd,Bd_d,Css,xs_MVP,us_MVP,z_min,z_max,z_ref,u_min,u_max,Wz,Weta_min,Weta_max,Wu_ba,Wu_delta_ba,Wu_bo,Wu_glu,x_bar,dmeal,u_1,OPT_var_x0,solver)
