function [x_arr,z_arr,y_arr,u_arr,d_arr,HR_arr,Z_bar,t_cost] = ClosedLoopSimulation_LMPC_multiple(Ad,Bd,Bd_d,Css,solver,xs_Hovorka,xs_MVP,us_MVP,ys,N,N_all,T,t,p_Hovorka,p_MVP,addSensorNoise,dW,addProcessNoise,z_min,z_max,z_ref,u_min,u_max,Wz,Weta_min,Weta_max,Wu_ba,Wu_delta_ba,Wu_bo,Wu_glu)
% Syntax: [x_arr,z_arr,y_arr,u_arr,d_arr,HR_arr,Z_bar,t_cost] = ClosedLoopSimulation_LMPC_multiple(Ad,Bd,Bd_d,Css,solver,xs_Hovorka,xs_MVP,us_MVP,ys,N,N_all,T,t,p_Hovorka,p_MVP,addSensorNoise,dW,addProcessNoise,z_min,z_max,z_ref,u_min,u_max,Wz,Weta_min,Weta_max,Wu_ba,Wu_delta_ba,Wu_bo,Wu_glu)
...
%         Wu_glu: weight value of the glucagon
...
P_kf = G*G';
R_kf = 0.02^2;
W_kf=diag([1 1 1 0.01 1 1 1 1 1])*T;
G_w=diag([1 1 1 1 1 1 1 1 1]);
...
x_bar=X_bar(:,k);
[x_bar,z_bar,P_kf] = KF_multiple(T,uk,x_bar,P_kf,R_kf,W_kf,G_w,d_arr(:,k)*1000,y_arr(:,k),Ad,Bd,Bd_d,Css,us_MVP,xs_MVP,ys);
...
sol = CasADiCompute_LMPC_multiple(N,T,Ad,Bd,Bd_d,Css,xs_MVP,us_MVP,z_min,z_max,z_ref,u_min,u_max,Wz,Weta_min,Weta_max,Wu_ba,Wu_delta_ba,Wu_bo,Wu_glu,x_bar-xs_MVP,d_arr(k)*1000,uk-us_MVP,OPT_var_x0,solver);
