function [x_bar,z_bar,P_kf] = CDEKF_multiple(T,uk,x_bar,P_kf,R_kf,G,dk,yk,p_MVP)
% Syntax: [x_bar,z_bar,P_kf] = CDEKF_multiple(T,uk,x_bar,P_kf,R_kf,G,dk,yk,p_MVP)
%         T: sampling time
...
% Prediction
% --------------------------------------------------------------
[x_bar,P_kf]=RK4_EKF_predict_multiple(T,x_bar,P_kf,G,[uk;dk],0,p_MVP);%MVP model meal[mg/min]
% --------------------------------------------------------------
% Update
% --------------------------------------------------------------
[C_kf,z_bar] = MVPOutputJacobian_multiple(x_bar);
e_kf=yk-z_bar;
